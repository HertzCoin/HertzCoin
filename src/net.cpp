...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "HertzCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
unsigned int pnSeed[] =
{
    0x3499c6ca, 0xe76af416, 0xae4ccf92, 0xcaba7cce, 0xf7a63762, 0x5e94fff5, 0x597f3555, 0x59fed644,
    0x529e21b4, 0xc12a576b, 0xd5f47d41, 0xf7952a65, 0xdc8e938a, 0x8c1efecd, 0x6fbbd62c, 0x9bdef4de,
    0x91565803, 0xd7091bdf, 0x82f82a6a, 0xb56aca97, 0xf1a8bedc, 0xab567338, 0x5b0d1a13, 0xe7d545b2,
    0xa9036d15
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HertzCoin is probably already running."), addrBind.ToString().c_str());
        else
